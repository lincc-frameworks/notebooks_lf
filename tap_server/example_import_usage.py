...
def example_command_line_usage():
    ...
    print()
    print("# Import a specific table by name")
    print("python import_tap_schema.py --url https://irsa.ipac.caltech.edu/TAP --table gaia_dr3_source")
    print()
    ...
    print("python import_tap_schema.py --url <TAP_URL> --table <table> --verbose")
    print()
...
def example_programmatic_usage():
    ...
    print()
    print("# Or import a specific table by name")
    print("with TAPSchemaImporter(tap_url, 'my_catalog.db') as importer:")
    print("    importer.import_table_by_name('gaia_dr3_source', include_keys=True)")
    print()
